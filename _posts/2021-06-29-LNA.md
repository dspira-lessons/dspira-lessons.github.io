...
+ [DSPIRA LNA](http://dspira-lessons.github.io/DetailedLNAInstructions) - designed by Professor Kevin Bandura at WVU to operate in urban environments. The total cost to build this LNA circuit is approximately $60. Details on ordering the parts and instructions on how to solder the circuit can be found [here](http://dspira-lessons.github.io/DetailedLNAInstructions). The gerbers files for fabricating this circuit on your own can be found [here](https://github.com/dspira-lessons/dspira-lessonsos_radio_astro_hw).
