...
* An SDR device (dongle) is needed for this system. See the [SDR Options page.](https://dspira-lessons.github.io//SDR)
...
* Instructions on how to use the *spectrometer_w_cal.grc* program can be found [here](https://dspira-lessons.github.io//spectrometer_w_cal_Instructions){:target="_blank"}. 
