...
+ RTL-SDR - will need to make a minor change in the source block in the Gnuradio program. For details see the [Spectrometer Source Block Settings page here]({{ site.baseurl }}/Spectrometer_sourceblock_settings).

+ Lime - This can be used with 2 horns to do interferometry as well as a single horn. It will need to use the Lime source block in the Gnuradio program. For details see the [Spectrometer Source Block Settings page here]({{ site.baseurl }}/Spectrometer_sourceblock_settings).

+ ADALM-PLUTO - uses the PlutoSDR source block that requires some steps for installing on a Linux system. For details see the [Spectrometer Source Block Settings page here]({{ site.baseurl }}/Spectrometer_sourceblock_settings).


For details on the changes needed in the source block mentioned above, refer to the [Spectrometer Source Block Settings page here]({{ site.baseurl }}/Spectrometer_sourceblock_settings).
